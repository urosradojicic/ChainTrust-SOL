...
| 🎙 | **[pitch-2min-talk-only.md](pitch-2min-talk-only.md)** | 5 min | **No-demo pitch** — for investor coffees, phone calls, podcasts, networking. Different rhythm, rule-of-three structure, mirror-rehearsal drill. Includes a 30-second elevator cut. |
