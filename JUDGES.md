...
3. [docs/LIVE_TESTNET_DEMO.md](docs/LIVE_TESTNET_DEMO.md) — full walkthrough of the on-chain demo.
4. [UPGRADE_NOTES.md](UPGRADE_NOTES.md) — Phase 5 senior-engineer cleanup notes.
